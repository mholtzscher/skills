...
2. **KPI dashboard** — lines added/removed, files changed, new modules, test counts. Include a **housekeeping** indicator: whether docs need changes (green/yellow/red) and whether release-note follow-up is needed (green/amber/red).
